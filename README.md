...
##### prepare database for the system #####
* create database in Mysql8, databasa name: bonuspointsexchange, username/passwd: bonuspoint/12345678

* run script bonuspointsexchange.sql to create tables: order, point, shop, transfer, user, userpoint
mysql -u USER  -p PASSWORD DATABASE   < bonuspointsexchange.sql




#### start web app through tomcat ####
